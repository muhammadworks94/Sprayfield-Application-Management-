...
{
    options.IdleTimeout = TimeSpan.FromHours(8); // Match cookie expiration
...
builder.Services.AddScoped<SAM.Services.Interfaces.IMonthlyReportProvisionerService, MonthlyReportProvisionerService>();
