...
""");
    ...
    private static IEnumerable<TraceabilityItemViewModel> BuildEntityPropertyCatalogTraceability()
    {
        ...
        var moduleMap = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["MonthlyApplication"] = "Operational Data > Irrigation Entry",
            ["WWChar"] = "Operational Data > Wastewater Testing",
            ["WWCharTemplateValue"] = "Operational Data > Wastewater Testing (Template Values)",
            ["GWMonit"] = "Operational Data > Groundwater Testing",
            ["GWMonitTemplateValue"] = "Operational Data > Groundwater Testing (Template Values)",
            ["OperatorLog"] = "Operational Data > Operator Entry",
