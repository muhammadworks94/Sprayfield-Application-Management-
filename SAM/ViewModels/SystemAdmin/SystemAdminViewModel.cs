...
public class SystemAdminViewModel
{
    ...
    public IEnumerable<PermitListItemViewModel>? Permits { get; set; }
    public IEnumerable<LabOptionViewModel>? LabOptions { get; set; }
    ...
    public FilterViewModel? PermitsFilter { get; set; }
