...
namespace SAM.Migrations
{
    ...
    [Migration("20260730075727_AddFacilityOrcAssignments")]
    partial class AddFacilityOrcAssignments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SAM.Domain.Entities.Company", b =>
                {
                    ...
                    b.Property<int?>("FirstReportingMonth")
                        .HasColumnType("int");

                    b.Property<int?>("FirstReportingYear")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SAM.Domain.Entities.CompanyLabOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SAM.Domain.Entities.EmailLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("InitiatedByDisplayName")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.HasIndex("TemplateKey", "SentAtUtc");

                    b.HasIndex("ToEmail", "SentAtUtc");
            ...
            modelBuilder.Entity("SAM.Domain.Entities.Facility", b =>
                {
                    ...
                    b.Property<Guid?>("DefaultFacilityPermitId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("FacilityContactPersonPhone")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("FacilityContactPersonTitle")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.Property<decimal?>("LagoonBermHeightFeet")
                        .HasPrecision(8, 2)
                    ...
                    b.Property<string>("SigningOfficial")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.HasIndex("DefaultFacilityPermitId");

                    b.ToTable("Facilities", (string)null);
                });

            modelBuilder.Entity("SAM.Domain.Entities.FacilityOrcAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("FacilityId", "EndDate");

                    b.ToTable("FacilityOrcAssignments", (string)null);
                });
            ...
            modelBuilder.Entity("SAM.Domain.Entities.FacilityPermit", b =>
                {
                    ...
                    b.Property<bool>("ShowGw59Report")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("ShowNdar1Report")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("ShowNdmlrReport")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("ShowNdmrReport")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);
            ...
            modelBuilder.Entity("SAM.Domain.Entities.GWMonit", b =>
                {
                    ...
                    b.Property<Guid?>("LabOptionId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime?>("LabSampleAnalyzedDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("SAM.Domain.Entities.GWMonitTemplateValue", b =>
                {
                    ...
                    b.Property<bool>("IsReportingDetectionLimit")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
            ...
            modelBuilder.Entity("SAM.Domain.Entities.OperatorLog", b =>
                {
                    ...
                    b.Property<decimal?>("WaterDepthFt")
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("SAM.Domain.Entities.Sprayfield", b =>
                {
                    ...
                    b.Property<decimal?>("ActualHourlyRateInches")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("SAM.Domain.Entities.SprayfieldBaselineMonthlyLoading", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("LoadingInches")
                        .HasColumnType("decimal(18,6)");
                    ...
                    b.HasIndex("FacilityId", "SprayfieldId", "Year", "Month")
                        .IsUnique();

                    b.ToTable("SprayfieldBaselineMonthlyLoadings", (string)null);
                });
            ...
            modelBuilder.Entity("SAM.Domain.Entities.WWChar", b =>
                {
                    ...
                    b.Property<string>("SamplingPerson1")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("SamplingPerson2")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<Guid?>("SecondaryLabOptionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SecondaryLabOptionId");
            ...
            modelBuilder.Entity("SAM.Domain.Entities.Facility", b =>
                {
                    ...
                    b.HasOne("SAM.Domain.Entities.FacilityPermit", "DefaultFacilityPermit")
                        .WithMany()
                        .HasForeignKey("DefaultFacilityPermitId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.Navigation("Company");

                    b.Navigation("DefaultFacilityPermit");
                });

            modelBuilder.Entity("SAM.Domain.Entities.FacilityOrcAssignment", b =>
                {
                    b.HasOne("SAM.Domain.Entities.Facility", "Facility")
                        .WithMany("OrcAssignments")
                        .HasForeignKey("FacilityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SAM.Domain.Entities.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("SAM.Domain.Entities.GWMonit", b =>
                {
                    ...
                    b.HasOne("SAM.Domain.Entities.CompanyLabOption", "LabOption")
                        .WithMany("GWMonits")
            ...
            modelBuilder.Entity("SAM.Domain.Entities.WWChar", b =>
                {
                    ...
                    b.HasOne("SAM.Domain.Entities.CompanyLabOption", "SecondaryLabOption")
                        .WithMany()
                        .HasForeignKey("SecondaryLabOptionId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("SecondaryLabOption");
                });
